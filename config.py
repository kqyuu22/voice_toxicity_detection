...
OUTPUT_DIRS = {
    "pipeline_results": OUTPUT_ROOT / "pipeline_results",
    "visualizations": OUTPUT_ROOT / "evaluation" / "visualizations",
    "transcriptions": OUTPUT_ROOT / "evaluation" / "transcriptions",
...
# Output file paths
AUDIO_OUTPUT = OUTPUT_DIRS["pipeline_results"] / "recording_output.wav"
TRANSCRIPTION_OUTPUT = OUTPUT_DIRS["pipeline_results"] / "recording_output_transcription.txt"
